...
LoRa_App loraAppStatus = {
    .devAddr.u32 = 0x00001AB7, //Device address (LSB)
...
int GetSupportBand(void) {
	...
	return WiMOD_LoRaWAN_Msg_Req(LORAWAN_MSG_GET_SUPPORTED_BANDS_REQ, NULL, 0);
}
...
//	WiMOD_LoRaWAN_Msg_Req(LORAWAN_MSG_SET_DEVICE_EUI_REQ, &UsartTextString[2], 8);
        return WiMOD_LoRaWAN_Msg_Req(LORAWAN_MSG_SET_DEVICE_EUI_REQ,
        		(uint8_t*) &loraAppStatus.devEUI, 8);
}
//------------------------------------------------------------------------------
//
//  SetOPMODE
